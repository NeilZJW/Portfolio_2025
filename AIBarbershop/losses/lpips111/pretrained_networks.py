...
class vgg16(nn.Module):
    def __init__(self, requires_grad=False, pretrained=True):
        super().__init__()
        vgg16_pretrained_features = tv.vgg16(
            pretrained=pretrained
        ).features
        self.slice1 = nn.Sequential()
        self.slice2 = nn.Sequential()
    ...
    def forward(self, X):
        ...
        vgg_outputs = namedtuple(
            "VggOutputs",
            ["relu1_2", "relu2_2", "relu2_3", "relu4_3", "relu5_3"]
        )
...
class ResNet(nn.Module):
    ...
    def forward(self, X):
        ...
        out = resnetoutputs(h_relu1, h_conv2, h_conv3, h_conv4, h_conv5)
        return out
